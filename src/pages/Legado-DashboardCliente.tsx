// Deprecated legacy entrypoint: page moved to folder `src/pages/DashboardCliente/index.tsx`.
// This file now re-exports the new folder index to keep existing imports working during the refactor.
export { default } from './DashboardCliente/index';
...
import CadastroTab from './DashboardCliente/CadastroTab';
import ServicosTab from './DashboardCliente/ServicosTab';
    ...
    <DashboardLayout title="Painel do Cliente" tabs={tabs} activeTab={activeTab} onTabChange={setActiveTab}>
      ...
      {activeTab === 'documentos' && (
        <div className="space-y-6">
          ...
          {/* Certificado removido desta aba — agora reside na aba de emissão de NF */}
