  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center p-4">
      <div className="bg-card rounded-lg shadow-xl w-full max-w-md p-8">
        ...
        <div className="mb-6 p-4 bg-muted rounded-lg border border-muted-foreground/20">
          ...
          <p className="text-xs text-muted-foreground mt-2">Crie sua conta para acessar o painel da TopMEI. </p>
        </div>
        ...
        <form onSubmit={handleCadastro} className="space-y-4">
          ...
          <div>
            ...
            className={`pl-12 ${errors.nome ? 'border-destructive' : ''}`} disabled={isLoading} />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input id="senha" type={showPassword ? 'text' : 'password'} value={senha} onChange={e => {
            ...
            // ** CORREÇÃO AQUI **
            className={`pl-12 pr-12 ${errors.senha ? 'border-destructive' : ''}`} disabled={isLoading} />
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
              <Input id="senhaConfirm" type={showPassword ? 'text' : 'password'} value={senhaConfirm} onChange={e => {
              setSenhaConfirm(e.target.value);
              if (errors.senhaConfirm) setErrors({
                ...errors,
                senhaConfirm: undefined
              });
            }} placeholder="Confirme sua senha"
            // ** CORREÇÃO AQUI **
            className={`pl-12 pr-12 ${errors.senhaConfirm ? 'border-destructive' : ''}`} disabled={isLoading} />
            </div>
